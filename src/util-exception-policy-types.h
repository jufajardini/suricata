...
enum ExceptionPolicyTargetValues {
    EXCEPTION_TARGET_ENUM_NONE = 0,
    EXCEPTION_TARGET_ENUM_DEFRAG_MEMCAP,
#define EXCEPTION_TARGET_FLAG_DEFRAG_MEMCAP BIT_U16(0)
    EXCEPTION_TARGET_ENUM_SESSION_MEMCAP,
#define EXCEPTION_TARGET_FLAG_SESSION_MEMCAP BIT_U16(1)
    EXCEPTION_TARGET_ENUM_REASSEMBLY_MEMCAP,
#define EXCEPTION_TARGET_FLAG_REASSEMBLY_MEMCAP BIT_U16(2)
    EXCEPTION_TARGET_ENUM_FLOW_MEMCAP,
#define EXCEPTION_TARGET_FLAG_FLOW_MEMCAP BIT_U16(3)
    EXCEPTION_TARGET_ENUM_MIDSTREAM,
#define EXCEPTION_TARGET_FLAG_MIDSTREAM BIT_U16(4)
    EXCEPTION_TARGET_ENUM_APPLAYER_ERROR,
#define EXCEPTION_TARGET_FLAG_APPLAYER_ERROR BIT_U16(5)
};

#define EXCEPTION_POLICY_TARGETS_MAX (EXCEPTION_TARGET_ENUM_APPLAYER_ERROR + 1)
