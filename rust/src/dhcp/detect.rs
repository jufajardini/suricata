...
pub unsafe extern "C" fn SCDetectDHCPRegister() {
    ...
    SCDetectKeywordAppLayerMapRegister(G_DHCP_LEASE_TIME_KW_ID, G_DHCP_LEASE_TIME_BUFFER_ID);
    let kw = SCSigTableAppLiteElmt {
    ...
    SCDetectKeywordAppLayerMapRegister(G_DHCP_RENEWAL_TIME_KW_ID, G_DHCP_RENEWAL_TIME_BUFFER_ID);
}
