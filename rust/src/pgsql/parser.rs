...
named!(pub parse_pgsql_startup_record_len_proto<PGSQLStartupPacket>,
    do_parse!(
...
mod tests {
    ...
    fn test_parse_pgsql_startup_packet_complete() {
        ...
        let result = parse_pgsql_startup_record_len_proto(&valid_buff);
    ...
    fn test_parse_pgsql_startup_packet_invalid_input1() {
        ...
        let result = parse_pgsql_startup_record_len_proto(&invalid_length_field_buff);
    ...
    fn test_parse_pgsql_startup_packet_invalid_input2() {
        ...
        let result = parse_pgsql_startup_record_len_proto(&invalid_proto_version_buff);
    ...
    fn test_parse_pgsql_startup_packet_incomplete() {
        ...
        let result = parse_pgsql_startup_record_len_proto(&invalid_data_length_buff);
