...
pub(super) unsafe extern "C" fn detect_ntp_register() {
    ...
    SCDetectKeywordAppLayerMapRegister(G_NTP_VERSION_KW_ID, G_NTP_GENERIC_BUFFER_ID);
    ...
    SCDetectKeywordAppLayerMapRegister(G_NTP_MODE_KW_ID, G_NTP_GENERIC_BUFFER_ID);
    ...
    SCDetectKeywordAppLayerMapRegister(G_NTP_STRATUM_KW_ID, G_NTP_GENERIC_BUFFER_ID);
    ...
    let g_ntp_reference_id_kw_id = helper_keyword_register_sticky_buffer(&kw);
    ...
    SCDetectKeywordAppLayerMapRegister(g_ntp_reference_id_kw_id, G_NTP_REFERENCE_ID_BUFFER_ID);
}
