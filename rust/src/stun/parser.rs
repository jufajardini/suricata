...
use nom7::IResult;
use nom7::number::streaming::{be_u8, be_u16, be_u128};
...
pub struct StunMessage {
    pub message_type: u16, // mandatory two 0 bits start, so msg_type actually 14 bits long
...
mod tests {
    ...
    fn test_parse_attributes() {
        let buf = &[
            0x00, 0x06, 0x00, 0x19, 0x54, 0x77, 0x35, 0x58,
            0x6d, 0x47, 0x41, 0x42, 0x54, 0x55, 0x35, 0x35,
            0x75, 0x36, 0x46, 0x32, 0x3a, 0x33, 0x31, 0x65,
            0x35, 0x38, 0x62, 0x62, 0x36, 0x00, 0x00, 0x00
          ];
    ...
    fn test_parse_message() {
        ...
        let buf1 = &[
            ...
            0x25, 0x98, 0xa6, 0x5b, 0x97, 0x10, 0xb8, 0x98,
            0x65, 0xbc, 0x34, 0x40, 0x00, 0x06, 0x00, 0x19,
            0x54, 0x77, 0x35, 0x58, 0x6d, 0x47, 0x41, 0x42,
            0x54, 0x55, 0x35, 0x35, 0x75, 0x36, 0x46, 0x32,
            0x3a, 0x33, 0x31, 0x65, 0x35, 0x38, 0x62, 0x62,
            0x36, 0x00, 0x00, 0x00, 0x00, 0x25, 0x00, 0x00,
            0x00, 0x24, 0x00, 0x04, 0x6e, 0x7f, 0x00, 0xff,
            0x80, 0x2a, 0x00, 0x08, 0x9e, 0x68, 0x1f, 0x4a,
            0x7b, 0x38, 0xb1, 0xcc, 0x00, 0x08, 0x00, 0x14,
            0x73, 0x20, 0xf8, 0x7b, 0x2a, 0xfd, 0x14, 0xaa,
            0xe9, 0x87, 0xea, 0xc3, 0xa8, 0x5b, 0x6b, 0xcb,
            0x31, 0xce, 0xa5, 0x50, 0x80, 0x28, 0x00, 0x04,
            0x28, 0x7c, 0x89, 0x26
        ];
