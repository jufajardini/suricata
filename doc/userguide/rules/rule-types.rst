...
.. list-table:: Suricata Rule Types
    ...
    * - IP Only (contains negated address) :sup:`1`
    ...
    * - Application Layer Protocol :ref:`transactions`
...
.. note:: Action Scope: `Flow, if stateful`
    ...
    (2) Apply to the flow. If a segment isn't accepted into a stream for any
